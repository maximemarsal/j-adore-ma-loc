      ...
      <View style={styles.grid}>
        {categories.map((category, index) => {
          ...
          return (
            ...
            >
              <Pressable
                style={[styles.card, isUrgency && styles.urgencyCard]}
                onPress={() => onSelect(category)}
              >
                <View style={[styles.iconContainer, isUrgency && styles.urgencyIconContainer]}>
                  <IconComponent size={24} color={isUrgency ? '#ffffff' : '#0a373e'} />
                </View>
                <Text style={[styles.cardLabel, isUrgency && styles.urgencyLabel]}>
                  {category.label}
                </Text>
              </Pressable>
            </MotiView>
